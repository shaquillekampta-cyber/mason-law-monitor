...
MINING_WATCHLIST = [
    ...
    # ── Government / agency investment ────────────────────────────────────────
    {"label": "IFC Mining",               "pattern": ("IFC", "mining"),          "group": "sector"},
    {"label": "DFC Mining",               "pattern": ("DFC", "mining"),          "group": "sector"},
    {"label": "World Bank Mining",        "pattern": ("world bank", "mining"),   "group": "sector"},
    {"label": "Sovereign Fund Mining",    "pattern": ("sovereign", "mining"),    "group": "sector"},
    {"label": "Minerals Security Partnership", "pattern": "minerals security partnership", "group": "sector"},
    {"label": "Critical Raw Materials Act",    "pattern": "critical raw materials act",    "group": "sector"},
    {"label": "Government Mining Investment",  "pattern": ("government", "mining investment"), "group": "sector"},
]
